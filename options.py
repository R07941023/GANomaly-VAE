...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--manualseed', default=0, type=int, help='manual seed')
        self.parser.add_argument('--abnormal_class', default='car', help='Anomaly class idx for mnist and cifar datasets')
        self.parser.add_argument('--proportion', type=float, default=0.1, help='Proportion of anomalies in test set for mnist.')
        self.parser.add_argument('--metric', type=str, default='roc', help='Evaluation metric.')

        ##
        # Train
        self.parser.add_argument('--print_freq', type=int, default=100, help='frequency of showing training results on console')
        self.parser.add_argument('--save_image_freq', type=int, default=10, help='frequency of saving real and fake images')
        self.parser.add_argument('--save_model_freq', type=int, default=10, help='frequency of saving model')
        self.parser.add_argument('--save_test_images', default=True, action='store_true', help='Save test images for demo.')
        self.parser.add_argument('--load_weights', default=0, type=int, help='Load the pretrained weights')
        ...
        self.parser.add_argument('--niter', type=int, default=15000, help='number of epochs to train for')
        ...
        self.parser.add_argument('--w_val_NG', type=float, default=10, help='Encoder loss weight.')
        self.parser.add_argument('--pass_rate', type=float, default=0.9, help='Encoder loss weight.')
        self.isTrain = True
        self.opt = None
